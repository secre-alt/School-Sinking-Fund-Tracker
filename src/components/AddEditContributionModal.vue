                ...
                <div class="p-6">
                    ...
                    <form @submit.prevent="saveContribution">
                        ...
                        <div class="flex justify-center gap-4 pt-4 border-t">          
                            ...
                            <button type="button" @click="closeModal" class="px-4 py-2 border-2 border-solid border-indigo-600 text-indigo-600 bg-transparent rounded-lg hover:bg-indigo-50">
                                Cancel
                            </button>
                        </div>
                    </form>
